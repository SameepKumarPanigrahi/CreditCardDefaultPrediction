...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            training_file_name = data_ingestion_info[DATA_INGESTION_TRAINING_FILE_NAME]
            training_file_path = os.path.join(ROOT_DIR, data_ingestion_info[DATA_INGESTION_TRAINING_FILE_PATH])
    ...
    def get_model_trainer_config(self)->ModelTrainerConfig:
        try:
            ...
            model_trainer_config_info = self.config_info[MODEL_TRAINER_CONGIG_KEY]
            trained_model_file_path = os.path.join(model_trainer_artifact_dir,
                                                  model_trainer_config_info[MODEL_TRAINER_TRAINED_MODEL_KEY],
                                                   model_trainer_config_info[MODEL_TRAINER_TRAINED_MODEL_FILE_NAME_KEY])
            
            bas_accuracy = model_trainer_config_info[MODEL_TRAINER_BASE_ACCURACY_KEY]
